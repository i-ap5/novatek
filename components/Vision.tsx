      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-20 grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="p-6 md:p-24 bg-zinc-900/5 space-y-12">
          <div className="space-y-6">
            <h4 className="text-white text-lg font-mono tracking-wider uppercase">focus on quality</h4>
          ...
          <div className="space-y-6 pt-12 border-t border-border-light">
            <h4 className="text-white text-lg font-mono tracking-wider uppercase">staying agile</h4>
            <p className="text-zinc-500 font-light leading-relaxed">
